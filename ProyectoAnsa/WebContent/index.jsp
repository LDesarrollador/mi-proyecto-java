...
<%@page import="Persistencia.login"%>
...
<body
	onload=<%JOptionPane.showMessageDialog(null, "Bienvenido al sistema", "Bienvenido", JOptionPane.DEFAULT_OPTION); %>
	background="imagenes/f.jpg"
	...
	<center>
		...
		<sj:dialog id="Ingresar" autoOpen="false" modal="true"
			...
			<form action="index.jsp" method="POST">
				...
				&nbsp Usuario: &nbsp &nbsp &nbsp &nbsp <input type="text" name="usu">
				<br>
				<br> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
				&nbsp &nbsp &nbsp Contrase&ntildea: &nbsp <input type="password"
					name="contra"><br>
				<br>
				<br> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
				&nbsp &nbsp &nbsp <input type="submit" name="btningresar"
					value="ingresar"> <br>
				<br>
				<marquee width="80%" behavior="alternate">Ingrese su
					usuario y contrase&ntildea</marquee>
			</form>
		</sj:dialog>
	</center>
	...
	if(request.getParameter("btningresar")!=null){
		...
		switch(log.loguear(usuar, contras)){
		case 1:
			
			sesio.setAttribute("user", usuar);
			sesio.setAttribute("idtipo", 1);
			response.sendRedirect("menuUs.jsp");
			break;
		case 2:
			sesio.setAttribute("user", usuar);
			sesio.setAttribute("idtipo", 2);
			response.sendRedirect("2.jsp");
			break;
		default:
	
		      JOptionPane.showMessageDialog(null, "Usuario o contrase\u00f1a no valida", "No se pudo acceder", JOptionPane.WARNING_MESSAGE);
