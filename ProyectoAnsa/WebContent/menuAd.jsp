...
<body>
	...
	<div class="container">
		...
		<div class="header">
			...
			<font size="2" color="white">Hola : <s:label>
		...
		<div class="content">
			...
			<div class="more">
				...
				<ul>
					...
					<sj:a openDialog="acercade" button="true" effect=""
						buttonIcon="uri-icon-newwin">Acerca de:</sj:a>
					<sj:dialog id="acercade" autoOpen="false" modal="true"
						title="Gracias por la preferencia" height="250" width="650">
			...
			<ul class="ca-menu">
				...
				<li><a href="cargaMantemientoVentaXML"> <span
						...
						<div class="ca-content">
							...
							<h3 class="ca-sub">Detalle de ventas</h3>
